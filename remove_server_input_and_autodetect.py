...
<body class="light-theme">
    ...
    <main class="container admin-main">
        ...
        <!-- Password Auth Section (Clean Single Password Prompt) -->
    ...
    <script>
        ...
        // Smart Automatic Backend Detection (No Manual Input Required)
        function getBackendBaseUrl() {
            ...
            if (host.includes('vercel.app')) {
                return ''; // Relative path on Vercel
            }
            // Fallback for GitHub Pages and Cloudflare Pages
            return 'https://natgea-thnaweya.abdohamdii701.workers.dev';
        }
        ...
        async function fetchDashboardData() {
            ...
            const endpoint = `${baseUrl}/api/admin/logs?key=${encodeURIComponent(adminKey)}&_t=${Date.now()}`;
