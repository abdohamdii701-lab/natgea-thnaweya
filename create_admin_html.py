...
<body class="light-theme">
    ...
    <main class="container admin-main">
        ...
        <div id="authSection" class="auth-card">
            ...
            <form id="authForm" style="display:flex; flex-direction:column; gap:1rem;">
                <input type="password" id="adminKeyInput" class="styled-input" placeholder="أدخل كلمة السر (Default: admin123)..." required autofocus>
    ...
    <script>
        ...
        async function fetchDashboardData() {
            try {
                const res = await fetch(`/api/admin/logs?key=${encodeURIComponent(adminKey)}`);
...
# Write admin.html to root and dist
locations = ['admin.html', 'dist/admin.html']
for loc in locations:
    with open(loc, 'w', encoding='utf-8') as f:
        f.write(admin_html_content)

print("Created admin.html in root and dist.")
